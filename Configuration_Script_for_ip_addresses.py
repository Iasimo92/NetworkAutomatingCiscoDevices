...
print("#####################################")
child1 = pexpect.spawn('ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 -c aes128-cbc 192.168.56.152 -l user')
...
print("#####################################")
child2 = pexpect.spawn('ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 -c aes128-cbc 192.168.56.153 -l user')
...
print("#####################################")
child2 = pexpect.spawn('ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 -c aes128-cbc 192.168.56.146 -l user')
child2.expect('Password:')
child2.sendline('pass')
child2.expect('R1>')
child2.sendline('enable')
