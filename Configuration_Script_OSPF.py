...
print("#####################################")
child1 = pexpect.spawn('ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 -c aes128-cbc 192.168.56.146 -l iasonas')
...
print("#####################################")
child2 = pexpect.spawn('ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 -c aes128-cbc 192.168.56.152 -l iasonas')
...
print("#####################################")
child3 = pexpect.spawn('ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 -c aes128-cbc 192.168.56.153 -l iasonas')
child3.expect('Password:')
child3.sendline('ericsson')
child3.expect('R5>')
